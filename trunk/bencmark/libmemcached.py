...
class BenchMarker(threading.Thread):
	...
	self.id = id
	self.mc = cmemcached.Client(["192.168.3.155:11211"])
...
if __name__ == '__main__':
    ...
    def	Usage():
	print 
        print "python memcached benchmark run libmemcached "
    ...
    pool_size   = 10
    is_obj 	= False
    opts,args=getopt.getopt(sys.argv[1:],'k::v::p::w::r::oh', "key==,value==, poolsize==,testobj, help")
